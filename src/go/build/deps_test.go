...
var pkgDeps = map[string][]string{
	...
	"net": {
		...
		// adding all of netstack. perhaps it can be trimmed down on its dependencies...
	...
	// all netstack stuff
	"vendor/github.com/google/btree":                                {"fmt", "io", "sort", "strings", "sync"},
	"vendor/github.com/google/netstack/rand":                        {"crypto/rand", "io", "sync"},
	"vendor/github.com/google/netstack/sleep":                       {"sync/atomic", "unsafe"},
	"vendor/github.com/google/netstack/tcpip":                       {"errors", "fmt", "github.com/google/netstack/tcpip/buffer", "github.com/google/netstack/tcpip/iptables", "github.com/google/netstack/waiter", "math/bits", "reflect", "strconv", "strings", "sync", "sync/atomic", "time", "unsafe"},
	"vendor/github.com/google/netstack/tcpip/hash/jenkins":          {"hash"},
	"vendor/github.com/google/netstack/tcpip/header":                {"encoding/binary", "github.com/google/btree", "github.com/google/netstack/tcpip", "github.com/google/netstack/tcpip/buffer", "github.com/google/netstack/tcpip/seqnum", "strings"},
	"vendor/github.com/google/netstack/tcpip/iptables":              {"github.com/google/netstack/tcpip/buffer"},
	"vendor/github.com/google/netstack/tcpip/link/fdbased":          {"bufio", "encoding/binary", "fmt", "github.com/google/netstack/tcpip", "github.com/google/netstack/tcpip/buffer", "github.com/google/netstack/tcpip/header", "github.com/google/netstack/tcpip/link/rawfile", "github.com/google/netstack/tcpip/stack", "os", "reflect", "sync/atomic", "syscall", "unsafe"},
	"vendor/github.com/google/netstack/tcpip/link/rawfile":          {"fmt", "github.com/google/netstack/tcpip", "syscall", "unsafe"},
	"vendor/github.com/google/netstack/tcpip/link/sniffer":          {"bytes", "encoding/binary", "fmt", "github.com/google/netstack/tcpip", "github.com/google/netstack/tcpip/buffer", "github.com/google/netstack/tcpip/header", "github.com/google/netstack/tcpip/stack", "io", "log", "os", "sync/atomic", "time"},
	"vendor/github.com/google/netstack/tcpip/link/tun":              {"syscall", "unsafe"},
	"vendor/github.com/google/netstack/tcpip/network/arp":           {"github.com/google/netstack/tcpip", "github.com/google/netstack/tcpip/buffer", "github.com/google/netstack/tcpip/header", "github.com/google/netstack/tcpip/stack"},
	"vendor/github.com/google/netstack/tcpip/network/fragmentation": {"container/heap", "fmt", "github.com/google/netstack/tcpip/buffer", "log", "math", "sync", "time"},
	"vendor/github.com/google/netstack/tcpip/network/hash":          {"encoding/binary", "github.com/google/netstack/rand", "github.com/google/netstack/tcpip/header"},
	"vendor/github.com/google/netstack/tcpip/network/ipv4":          {"encoding/binary", "github.com/google/netstack/tcpip", "github.com/google/netstack/tcpip/buffer", "github.com/google/netstack/tcpip/header", "github.com/google/netstack/tcpip/network/fragmentation", "github.com/google/netstack/tcpip/network/hash", "github.com/google/netstack/tcpip/stack", "sync/atomic"},
	"vendor/github.com/google/netstack/tcpip/network/ipv6":          {"encoding/binary", "github.com/google/netstack/tcpip", "github.com/google/netstack/tcpip/buffer", "github.com/google/netstack/tcpip/header", "github.com/google/netstack/tcpip/stack"},
	"vendor/github.com/google/netstack/tcpip/ports":                 {"github.com/google/netstack/tcpip", "math", "math/rand", "sync"},
	"vendor/github.com/google/netstack/tcpip/stack":                 {"fmt", "github.com/google/netstack/ilist", "github.com/google/netstack/sleep", "github.com/google/netstack/tcpip", "github.com/google/netstack/tcpip/buffer", "github.com/google/netstack/tcpip/hash/jenkins", "github.com/google/netstack/tcpip/header", "github.com/google/netstack/tcpip/iptables", "github.com/google/netstack/tcpip/ports", "github.com/google/netstack/tcpip/seqnum", "github.com/google/netstack/waiter", "math/rand", "strings", "sync", "sync/atomic", "time"},
	"vendor/github.com/google/netstack/tcpip/transport/icmp":        {"encoding/binary", "fmt", "github.com/google/netstack/tcpip", "github.com/google/netstack/tcpip/buffer", "github.com/google/netstack/tcpip/header", "github.com/google/netstack/tcpip/iptables", "github.com/google/netstack/tcpip/stack", "github.com/google/netstack/tcpip/transport/raw", "github.com/google/netstack/waiter", "sync"},
	"vendor/github.com/google/netstack/tcpip/transport/raw":         {"github.com/google/netstack/tcpip", "github.com/google/netstack/tcpip/buffer", "github.com/google/netstack/tcpip/header", "github.com/google/netstack/tcpip/iptables", "github.com/google/netstack/tcpip/stack", "github.com/google/netstack/waiter", "sync"},
	"vendor/github.com/google/netstack/tcpip/transport/tcp":         {"container/heap", "crypto/sha1", "encoding/binary", "fmt", "github.com/google/btree", "github.com/google/netstack/rand", "github.com/google/netstack/sleep", "github.com/google/netstack/tcpip", "github.com/google/netstack/tcpip/buffer", "github.com/google/netstack/tcpip/header", "github.com/google/netstack/tcpip/iptables", "github.com/google/netstack/tcpip/seqnum", "github.com/google/netstack/tcpip/stack", "github.com/google/netstack/tcpip/transport/raw", "github.com/google/netstack/tmutex", "github.com/google/netstack/waiter", "hash", "io", "math", "strings", "sync", "sync/atomic", "time"},
	"vendor/github.com/google/netstack/tcpip/transport/udp":         {"github.com/google/netstack/tcpip", "github.com/google/netstack/tcpip/buffer", "github.com/google/netstack/tcpip/header", "github.com/google/netstack/tcpip/iptables", "github.com/google/netstack/tcpip/stack", "github.com/google/netstack/tcpip/transport/raw", "github.com/google/netstack/waiter", "math", "sync"},
	"vendor/github.com/google/netstack/tmutex":                      {"sync/atomic"},
	"vendor/github.com/google/netstack/waiter":                      {"sync"},
